  package com.project.selsal.config;
  ...
  @MapperScan(basePackages = "com.project.selsal")
  
  @EnableTransactionManagement public class MabatisConfig {
  ...
  final SqlSessionTemplate sqlSessionTemplate = new
